...
[v0]trim=0.00:1.00,setpts=PTS-STARTPTS[v1];
[a0]atrim=0.00:1.00,asetpts=PTS-STARTPTS[a1];
[v0]trim=2.00:3.00,setpts=PTS-STARTPTS[v3];
[a0]atrim=2.00:3.00,asetpts=PTS-STARTPTS[a3];
